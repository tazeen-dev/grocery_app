    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Padding(
          ...
          child: ListTile(
            leading: Image.asset(widget.profileitems[index].image),
            title: BlackTextWidget(
              text: widget.profileitems[index].text,
              fontSize: 12,
            ...
            trailing: Padding(
              ...
              child: Icon(
                widget.profileitems[index].icon,
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => widget.profileitems[index].screen,
                ),
              );
            },
          ),
